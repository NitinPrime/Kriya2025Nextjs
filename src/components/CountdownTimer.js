...
function CountdownTimer() {
  const calculateTimeLeft = () => {
    const eventDate = new Date("2025-01-14T17:00:00"); // Updated event date and time
    const now = new Date();
    ...
    if (difference > 0) {
      ...
      return { days: 0, hours: 0, minutes: 0, seconds: 0 }; // Countdown stops after the event starts
    }
  };
